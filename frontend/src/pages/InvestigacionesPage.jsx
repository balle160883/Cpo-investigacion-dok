...
export default function InvestigacionesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ===== DEMO PREVIEW: VIGENCIA 90 DÍAS ===== */}
      <div className="rounded-2xl border border-dashed border-amber-500/50 bg-amber-950/20 overflow-hidden">
        <div className="flex items-center justify-between px-4 py-2.5 bg-amber-500/10 border-b border-amber-500/20">
          <div className="flex items-center gap-2">
            <span className="text-amber-400 font-bold text-sm">🔬 Vista Previa — Vigencia de 90 Días</span>
            <span className="text-amber-500/70 text-xs">Así se verá cuando una persona ya tenga visita previa válida</span>
          </div>
        </div>

        {/* Demo: Banner en Detalle de Investigación */}
        <div className="p-4 space-y-4">
          <div>
            <p className="text-xs text-amber-400/80 uppercase font-bold tracking-wider mb-2">① Banner en el Formato / Detalle de Investigación:</p>
            <div className="flex items-start gap-3 bg-emerald-950/60 border border-emerald-500/40 text-emerald-300 rounded-2xl p-4 shadow-lg shadow-emerald-500/10">
              ...
              <div className="text-sm leading-relaxed">
                ...
                <p className="text-emerald-400 mt-0.5">
                  ...
                  <strong className="text-white">01/Ago/2026</strong>.
                </p>
                <span className="inline-block mt-1.5 text-xs font-semibold text-emerald-300 underline cursor-pointer">
                  📎 Ver formato de la visita anterior #1035
                </span>
              </div>
            </div>
          </div>

          {/* Demo: Fila en la tabla */}
          <div>
            <p className="text-xs text-amber-400/80 uppercase font-bold tracking-wider mb-2">② Badge en la columna "Vigencia Visita" de la tabla:</p>
            <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
              <table className="w-full text-left text-sm text-slate-300">
                <thead className="bg-slate-950/60 text-xs text-slate-400 uppercase tracking-wider border-b border-slate-800">
                  <tr>
                    <th className="px-4 py-2.5">ID / Folio</th>
                    <th className="px-4 py-2.5">Tipo</th>
                    <th className="px-4 py-2.5">Nombre del Socio</th>
                    <th className="px-4 py-2.5">Vigencia Visita</th>
                    <th className="px-4 py-2.5">Estado</th>
                  </tr>
                </thead>
                <tbody>
                  {/* Fila CON vigencia vigente */}
                  <tr className="border-b border-slate-800/60 bg-emerald-950/10">
                    <td className="px-4 py-3 font-mono font-semibold text-slate-200">
                      <div>#1042</div>
                      <div className="text-[11px] text-slate-500 font-sans">Sol: SOL-2026-0891</div>
                    </td>
                    <td className="px-4 py-3">
                      <span className="px-2.5 py-1 rounded-full text-[10px] font-bold uppercase bg-purple-500/20 text-purple-400 border border-purple-500/30">Aval</span>
                    </td>
                    <td className="px-4 py-3 font-semibold text-white">MARIA CECILIA REVELES</td>
                    <td className="px-4 py-3 text-xs">
                      <div className="flex flex-col gap-1">
                        <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-emerald-500/15 text-emerald-400 border border-emerald-500/25 text-[10px] font-bold">
                          ...
                          Vigente hasta 01/Ago/2026
                        </span>
                        <span className="text-[10px] text-sky-500 underline pl-0.5 cursor-pointer">Ver visita #1035</span>
                      </div>
                    </td>
                    <td className="px-4 py-3">
                      <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-slate-800 text-slate-400 border border-slate-700">PENDIENTE</span>
                    </td>
                  </tr>
                  {/* Fila SIN vigencia */}
                  <tr className="border-b border-slate-800/60">
                    <td className="px-4 py-3 font-mono font-semibold text-slate-200">
                      <div>#1043</div>
                      <div className="text-[11px] text-slate-500 font-sans">Sol: SOL-2026-0892</div>
                    </td>
                    <td className="px-4 py-3">
                      <span className="px-2.5 py-1 rounded-full text-[10px] font-bold uppercase bg-sky-500/20 text-sky-400 border border-sky-500/30">Solicitante</span>
                    </td>
                    <td className="px-4 py-3 font-semibold text-white">CARLOS JAVIER López</td>
                    <td className="px-4 py-3 text-xs">
                      <span className="text-slate-600 text-[10px] italic">Sin visita previa</span>
                    </td>
                    <td className="px-4 py-3">
                      <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-amber-500/10 text-amber-400 border border-amber-500/20">EN_PROCESO</span>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <p className="text-xs text-slate-500 mt-2 pl-1">
              🟢 Fila verde = persona con visita previa válida (dentro de los 90 días). ⚫ Fila normal = requiere nueva visita.
            </p>
          </div>
        </div>
      </div>
